...
<AppShell
	slotSidebarLeft="bg-surface-50 dark:bg-primary-500 border-t border-surface-500/10 w-0 lg:w-64"
	slotPageFooter="bg-white dark:bg-primary-500 {classesPageFooterPartner} {classesPageFooterDataStories}"
	slotPageContent="bg-white dark:bg-primary-500 border-t border-surface-500/10 {classesPageContentPartner}"
	...
	<svelte:fragment slot="header">
		<AppBar background="bg-primary-500">
			<svelte:fragment slot="lead">
				<div class="flex">
					<button
						class="btn btn-sm mr-4 fill-white dark:fill-secondary-500 lg:hidden"
						on:click={drawerOpen}
					...
					<div class="h-12">
						<a
							href="{base}/"
							class="cursor-pointer fill-white dark:fill-secondary-500"
							aria-label="Home"
						>
							<svg xmlns="http://www.w3.org/2000/svg" class="h-full" viewBox="0 0 512 223.96"
								><path
